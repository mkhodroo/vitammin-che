...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{ url('public/dashboard/assets/images/favicon.png') }}">
...
<body class="skin-blue fixed-layout">
    ...
    <div class="preloader" id="preloader">
        <div class="loader">
            ...
            <p class="loader__label">ویتامین چ . لطفا منتظر بمانید</p>
        </div>
    </div>
    <!-- ============================================================== -->
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.html">
                        <!-- Logo icon --><b>
                            ...
                            <!-- Dark Logo icon -->
                            <img src="{{ url('public/dashboard/assets/images/logo.png') }}" alt="homepage" class="dark-logo"  width="200"/>
                            <!-- Light Logo icon -->
                            <img src="{{ url('public/dashboard/assets/images/logo.png') }}" alt="homepage" class="light-logo" width="200"/>
                        </b>
                        <!--End Logo icon -->
                </div>
                <!-- ============================================================== -->
                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div class="message-center">
                                            <!-- Message -->
                                            <a href="javascript:void(0)">
                                                <div class="user-img"> <img src="{{ url('public/dashboard/assets/images/users/Sample_User_Icon.png') }}" alt="user" class="img-circle"> <span class="profile-status online pull-right"></span> </div>
                                                <div class="mail-contnet">
                        ...
                        <li class="nav-item dropdown u-pro">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark profile-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="{{ url('public/dashboard/assets/images/users/Sample_User_Icon.png') }}" alt="user" class=""> <span class="hidden-md-down">Mark &nbsp;<i class="fa fa-angle-down"></i></span> </a>
    ...
    <script src="{{ url('public/dashboard/dist/js/perfect-scrollbar.jquery.min.js') }}"></script>
    <!--Wave Effects -->
    <script src="{{ url('public/dashboard/dist/js/waves.js') }}"></script>
    <!--Menu sidebar -->
    <script src="{{ url('public/dashboard/dist/js/sidebarmenu.js') }}"></script>
    <!--stickey kit -->
    <script src="{{ url('public/dashboard/assets/node_modules/sticky-kit-master/dist/sticky-kit.min.js') }}"></script>
    <script src="{{ url('public/dashboard/assets/node_modules/sparkline/jquery.sparkline.min.js') }}"></script>
    <!--Custom JavaScript -->
