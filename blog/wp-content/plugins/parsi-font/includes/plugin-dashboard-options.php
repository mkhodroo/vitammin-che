                ...
                <select name="dash_font_settings[dashmwfcfont]" id="dash_font_settings[dashmwfcfont]">
                    ...
                    <optgroup label="<?php _e('Persian Fonts', 'mwfc'); ?>">
                        ...
                        for ($i = 0; $i < count($mwfc_fonts); $i++) {
                            ?>
                            <option
                                <?php echo($options['dashmwfcfont'] == $mwfc_fonts[$i] ? "selected " : ""); ?>value="<?= $mwfc_fonts[$i]; ?>"><?= $mwfc_fonts[$i]; ?></option>
                        <?php } ?>
                    </optgroup>
                    <optgroup label="<?php _e('Latin Fonts', 'mwfc'); ?>">
                        ...
                        for ($i = 0; $i < count($mwfc_latinfonts); $i++) {
                            ?>
                            <option
                                <?php echo($options['dashmwfcfont'] == $mwfc_latinfonts[$i] ? "selected " : ""); ?>value="<?= $mwfc_latinfonts[$i]; ?>"><?= $mwfc_latinfonts[$i]; ?></option>
                        <?php } ?>
                    </optgroup>
                    <optgroup label="<?php _e('Fonts Combination', 'mwfc'); ?>">
                        ...
                        for ($i = 0; $i < count($mwfc_fonts); $i++) {
                            ...
                            <?php for ($j = 0; $j < count($mwfc_latinfonts); $j++) {
                                ...
                                ?>
                                <option
                                    <?php echo($options['dashmwfcfont'] == $mwfc_combine ? "selected " : ""); ?>value="<?= $mwfc_fonts[$i]; ?>, <?= $mwfc_latinfonts[$j]; ?>"><?= $mwfc_fonts[$i]; ?>
