                ...
                <select name="site_font_settings[hfontname]" id="site_font_settings[hfontname]">
                    ...
                    <optgroup label="<?php _e('Persian Fonts', 'mwfc'); ?>">
                        ...
                        for ($i = 0; $i < count($mwfc_fonts); $i++) {
                            ?>
                            <option
                                <?php echo($options['hfontname'] == $mwfc_fonts[$i] ? "selected " : ""); ?>value="<?= $mwfc_fonts[$i]; ?>"><?= $mwfc_fonts[$i]; ?></option>
                        <?php } ?>
                    </optgroup>
                    <optgroup label="<?php _e('Latin Fonts', 'mwfc'); ?>">
                        ...
                        for ($i = 0; $i < count($mwfc_latinfonts); $i++) {
                            ?>
                            <option
                                <?php echo($options['hfontname'] == $mwfc_latinfonts[$i] ? "selected " : ""); ?>value="<?= $mwfc_latinfonts[$i]; ?>"><?= $mwfc_latinfonts[$i]; ?></option>
                        <?php } ?>
                    </optgroup>
                    <optgroup label="<?php _e('Fonts Combination', 'mwfc'); ?>">
                        ...
                        for ($i = 0; $i < count($mwfc_fonts); $i++) {
                            ...
                            <?php for ($j = 0; $j < count($mwfc_latinfonts); $j++) {
                                ...
                                ?>
                                <option
                                    <?php echo($options['hfontname'] == $mwfc_combine ? "selected " : ""); ?>value="<?= $mwfc_fonts[$i]; ?>, <?= $mwfc_latinfonts[$j]; ?>"><?= $mwfc_fonts[$i]; ?>
                ...
                <select name="site_font_settings[bodyfontname]" id="site_font_settings[bodyfontname]">
                    ...
                    <optgroup label="<?php _e('Persian Fonts', 'mwfc'); ?>">
                        ...
                        for ($i = 0; $i < count($mwfc_fonts); $i++) {
                            ?>
                            <option
                                <?php echo($options['bodyfontname'] == $mwfc_fonts[$i] ? "selected " : ""); ?>value="<?= $mwfc_fonts[$i]; ?>"><?= $mwfc_fonts[$i]; ?></option>
                        <?php } ?>
                    </optgroup>
                    <optgroup label="<?php _e('Latin Fonts', 'mwfc'); ?>">
                        <?php
                        for ($i = 0; $i < count($mwfc_latinfonts); $i++) {
                            ?>
                            <option
                                <?php echo($options['bodyfontname'] == $mwfc_latinfonts[$i] ? "selected " : ""); ?>value="<?= $mwfc_latinfonts[$i]; ?>"><?= $mwfc_latinfonts[$i]; ?></option>
                        <?php } ?>
                    </optgroup>
                    <optgroup label="<?php _e('Fonts Combination', 'mwfc'); ?>">
                        <?php
                        for ($i = 0; $i < count($mwfc_fonts); $i++) {
                            ...
                            <?php for ($j = 0; $j < count($mwfc_latinfonts); $j++) {
                                ...
                                ?>
                                <option
                                    <?php echo($options['bodyfontname'] == $mwfc_combine ? "selected " : ""); ?>value="<?= $mwfc_fonts[$i]; ?>, <?= $mwfc_latinfonts[$j]; ?>"><?= $mwfc_fonts[$i]; ?>
                                    , <?= $mwfc_latinfonts[$j]; ?></option>
                            <?php }
                        } ?>
                    </optgroup>
                ...
                <select name="site_font_settings[adminfontname]" id="site_font_settings[adminfontname]">
                    ...
                    <optgroup label="<?php _e('Persian Fonts', 'mwfc'); ?>">
                        ...
                        for ($i = 0; $i < count($mwfc_fonts); $i++) {
                            ?>
                            <option
                                <?php echo($options['adminfontname'] == $mwfc_fonts[$i] ? "selected " : ""); ?>value="<?= $mwfc_fonts[$i]; ?>"><?= $mwfc_fonts[$i]; ?></option>
                        <?php } ?>
                    </optgroup>
                    <optgroup label="<?php _e('Latin Fonts', 'mwfc'); ?>">
                        <?php
                        for ($i = 0; $i < count($mwfc_latinfonts); $i++) {
                            ?>
                            <option
                                <?php echo($options['adminfontname'] == $mwfc_latinfonts[$i] ? "selected " : ""); ?>value="<?= $mwfc_latinfonts[$i]; ?>"><?= $mwfc_latinfonts[$i]; ?></option>
                        <?php } ?>
                    </optgroup>
                    <optgroup label="<?php _e('Fonts Combination', 'mwfc'); ?>">
                        <?php
                        for ($i = 0; $i < count($mwfc_fonts); $i++) {
                            ...
                            <?php for ($j = 0; $j < count($mwfc_latinfonts); $j++) {
                                ...
                                ?>
                                <option
                                    <?php echo($options['adminfontname'] == $mwfc_combine ? "selected " : ""); ?>value="<?= $mwfc_fonts[$i]; ?>, <?= $mwfc_latinfonts[$j]; ?>"><?= $mwfc_fonts[$i]; ?>
                                    , <?= $mwfc_latinfonts[$j]; ?></option>
                            <?php }
                        } ?>
                    </optgroup>
    ...
    <table class="form-table">
        ...
        <tr valign="top">
            ...
            <td><textarea name="site_font_settings[c1listidclass]" style="direction:ltr;" cols="60" rows="5"
                          ...
                          class="regular-text"><?php esc_attr_e($options['c1listidclass']); ?></textarea></td>
        </tr>
        <tr valign="top">
            <th scope="row">
                <?php _e('Font Family', 'mwfc'); ?>
                ...
                <select name="site_font_settings[c1fontname]" id="site_font_settings[c1fontname]">
                    ...
                    <optgroup label="<?php _e('Persian Fonts', 'mwfc'); ?>">
                        ...
                        for ($i = 0; $i < count($mwfc_fonts); $i++) {
                            ?>
                            <option
                                <?php echo($options['c1fontname'] == $mwfc_fonts[$i] ? "selected " : ""); ?>value="<?= $mwfc_fonts[$i]; ?>"><?= $mwfc_fonts[$i]; ?></option>
                        <?php } ?>
                    </optgroup>
                    <optgroup label="<?php _e('Latin Fonts', 'mwfc'); ?>">
                        <?php
                        for ($i = 0; $i < count($mwfc_latinfonts); $i++) {
                            ?>
                            <option
                                <?php echo($options['c1fontname'] == $mwfc_latinfonts[$i] ? "selected " : ""); ?>value="<?= $mwfc_latinfonts[$i]; ?>"><?= $mwfc_latinfonts[$i]; ?></option>
                        <?php } ?>
                    </optgroup>
                    <optgroup label="<?php _e('Fonts Combination', 'mwfc'); ?>">
                        <?php
                        for ($i = 0; $i < count($mwfc_fonts); $i++) {
                            ...
                            <?php for ($j = 0; $j < count($mwfc_latinfonts); $j++) {
                                ...
                                ?>
                                <option
                                    <?php echo($options['c1fontname'] == $mwfc_combine ? "selected " : ""); ?>value="<?= $mwfc_fonts[$i]; ?>, <?= $mwfc_latinfonts[$j]; ?>"><?= $mwfc_fonts[$i]; ?>
                                    , <?= $mwfc_latinfonts[$j]; ?></option>
                            <?php }
                        } ?>
                    </optgroup>
        ...
        <tr valign="top">
            ...
            <td>
                <select name="site_font_settings[c1fontsize]" id="site_font_settings[c1fontsize]">
                    ...
                    <?php for ($i = 5; $i < 61; $i++) { ?>
                        <option
                            <?php echo($options['c1fontsize'] == $i ? "selected " : ""); ?>value="<?php echo $i; ?>"><?php echo $i; ?></option>
                    <?php } ?>
                </select>
                <p class="description">
    ...
    <table class="form-table">
        ...
        <tr valign="top">
            ...
            <td><textarea name="site_font_settings[c2listidclass]" cols="60" rows="5" style="direction:ltr;"
                          ...
                          class="regular-text"><?php esc_attr_e($options['c2listidclass']); ?></textarea></td>
        </tr>
        <tr valign="top">
            <th scope="row">
                <?php _e('Font Family', 'mwfc'); ?>
                ...
                <select name="site_font_settings[c2fontname]" id="site_font_settings[c2fontname]">
                    ...
                    <optgroup label="<?php _e('Persian Fonts', 'mwfc'); ?>">
                        ...
                        for ($i = 0; $i < count($mwfc_fonts); $i++) {
                            ?>
                            <option
                                <?php echo($options['c2fontname'] == $mwfc_fonts[$i] ? "selected " : ""); ?>value="<?= $mwfc_fonts[$i]; ?>"><?= $mwfc_fonts[$i]; ?></option>
                        <?php } ?>
                    </optgroup>
                    <optgroup label="<?php _e('Latin Fonts', 'mwfc'); ?>">
                        <?php
                        for ($i = 0; $i < count($mwfc_latinfonts); $i++) {
                            ?>
                            <option
                                <?php echo($options['c2fontname'] == $mwfc_latinfonts[$i] ? "selected " : ""); ?>value="<?= $mwfc_latinfonts[$i]; ?>"><?= $mwfc_latinfonts[$i]; ?></option>
                        <?php } ?>
                    </optgroup>
                    <optgroup label="<?php _e('Fonts Combination', 'mwfc'); ?>">
                        <?php
                        for ($i = 0; $i < count($mwfc_fonts); $i++) {
                            ...
                            <?php for ($j = 0; $j < count($mwfc_latinfonts); $j++) {
                                ...
                                ?>
                                <option
                                    <?php echo($options['c2fontname'] == $mwfc_combine ? "selected " : ""); ?>value="<?= $mwfc_fonts[$i]; ?>, <?= $mwfc_latinfonts[$j]; ?>"><?= $mwfc_fonts[$i]; ?>
                                    , <?= $mwfc_latinfonts[$j]; ?></option>
                            <?php }
                        } ?>
                    </optgroup>
        ...
        <tr valign="top">
            ...
            <td>
                <select name="site_font_settings[c2fontsize]" id="site_font_settings[c2fontsize]">
                    ...
                    <?php for ($i = 5; $i < 61; $i++) { ?>
                        <option
                            <?php echo($options['c2fontsize'] == $i ? "selected " : ""); ?>value="<?php echo $i; ?>"><?php echo $i; ?></option>
                    <?php } ?>
                </select>
                <p class="description">
                    <?php _e('Please select font size.', 'mwfc'); ?>
    ...
    <table class="form-table">
        ...
        <tr valign="top">
            ...
            <td><textarea name="site_font_settings[c3listidclass]" cols="60" rows="5" style="direction:ltr;"
                          ...
                          class="regular-text"><?php esc_attr_e($options['c3listidclass']); ?></textarea></td>
        </tr>
        <tr valign="top">
            <th scope="row">
                <?php _e('Font Family', 'mwfc'); ?>
                ...
                <select name="site_font_settings[c3fontname]" id="site_font_settings[c3fontname]">
                    ...
                    <optgroup label="<?php _e('Persian Fonts', 'mwfc'); ?>">
                        ...
                        for ($i = 0; $i < count($mwfc_fonts); $i++) {
                            ?>
                            <option
                                <?php echo($options['c3fontname'] == $mwfc_fonts[$i] ? "selected " : ""); ?>value="<?= $mwfc_fonts[$i]; ?>"><?= $mwfc_fonts[$i]; ?></option>
                        <?php } ?>
                    </optgroup>
                    <optgroup label="<?php _e('Latin Fonts', 'mwfc'); ?>">
                        <?php
                        for ($i = 0; $i < count($mwfc_latinfonts); $i++) {
                            ?>
                            <option
                                <?php echo($options['c3fontname'] == $mwfc_latinfonts[$i] ? "selected " : ""); ?>value="<?= $mwfc_latinfonts[$i]; ?>"><?= $mwfc_latinfonts[$i]; ?></option>
                        <?php } ?>
                    </optgroup>
                    <optgroup label="<?php _e('Fonts Combination', 'mwfc'); ?>">
                        <?php
                        for ($i = 0; $i < count($mwfc_fonts); $i++) {
                            ...
                            <?php for ($j = 0; $j < count($mwfc_latinfonts); $j++) {
                                ...
                                ?>
                                <option
                                    <?php echo($options['c3fontname'] == $mwfc_combine ? "selected " : ""); ?>value="<?= $mwfc_fonts[$i]; ?>, <?= $mwfc_latinfonts[$j]; ?>"><?= $mwfc_fonts[$i]; ?>
                                    , <?= $mwfc_latinfonts[$j]; ?></option>
                            <?php }
                        } ?>
                    </optgroup>
        ...
        <tr valign="top">
            ...
            <td>
                <select name="site_font_settings[c3fontsize]" id="site_font_settings[c3fontsize]">
                    ...
                    <?php for ($i = 5; $i < 61; $i++) { ?>
                        <option
                            <?php echo($options['c3fontsize'] == $i ? "selected " : ""); ?>value="<?php echo $i; ?>"><?php echo $i; ?></option>
                    <?php } ?>
                </select>
                <p class="description">
                    <?php _e('Please select font size.', 'mwfc'); ?>
